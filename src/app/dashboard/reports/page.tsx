  ...
  return (
    <div ref={ref} className="p-8">
        <header className="flex justify-between items-center mb-8 pb-4 border-b">
            <Logo />
            <div>
                <h1 className="text-2xl font-bold font-headline">Financial Report</h1>
        ...
        <section className="mb-8">
            <h2 className="text-xl font-semibold mb-4 font-headline">Summary</h2>
            <ReportMetrics metrics={metrics} />
        </section>

        <section className="mb-8">
             <h2 className="text-xl font-semibold mb-4 font-headline">Income vs. Expense</h2>
         ...
         <section>
            <h2 className="text-xl font-semibold mb-4 font-headline">Expense Breakdown</h2>
            <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                    <Pie
        ...
        <footer className="mt-12 pt-4 border-t text-center text-xs text-muted-foreground">
            <p>Report generated by FinPulse on {format(new Date(), "LLL dd, y")}.</p>
        </footer>
    </div>
  );
});
