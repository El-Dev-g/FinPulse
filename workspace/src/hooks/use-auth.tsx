...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const getTruelayerAuthUrl = useCallback(() => {
    // This function will now simply redirect to our own API endpoint,
    // which then handles the redirect to Truelayer. This keeps all
    // environment variable logic on the server.
